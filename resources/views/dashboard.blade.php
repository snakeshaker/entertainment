    ...
    <section class="px-2 py-10 bg-white md:px-0">
        <div class="container w-full px-20 mx-auto">
            ...
            <div class="flex flex-row rounded-lg border border-gray-200/80 bg-white p-6 user-card">
                <div class="relative">
                    <img class="w-40 h-40 rounded-md object-cover" src="{{ asset('assets/blank-user.svg') }}"
                         alt="User" />
                </div>
                <div class="flex flex-col px-6">
                        ...
                        <div
                           class="flex h-20 px-5 flex-col items-center justify-center rounded-md border border-dashed border-gray-200 transition-colors duration-100 ease-in-out hover:border-gray-400/80">
                            <div class="flex flex-row items-center justify-center">
                                ...
                                <span class="font-bold text-gray-600 ml-2">{{ Carbon\Carbon::parse($user->created_at)->format('Y-m-d') }}</span>
                            </div>
                        ...
                        <div
                           class="flex h-20 px-5 flex-col items-center justify-center rounded-md border border-dashed border-gray-200 transition-colors duration-100 ease-in-out hover:border-gray-400/80">
                            <div class="flex flex-row items-center justify-center">
                                ...
                                <span class="font-bold text-gray-60 ml-2">{{ $user->tel_number }}</span>
                            </div>
                        ...
                        <div
                           class="flex h-20 px-5 flex-col items-center justify-center rounded-md border border-dashed border-gray-200 transition-colors duration-100 ease-in-out hover:border-gray-400/80">
                            <div class="flex flex-row items-center justify-center">
                                ...
                                <span class="font-bold text-gray-600 ml-2">{{ $user->birthday }}</span>
                            </div>
                    ...
                    <div class="w-100 flex flex-grow flex-col items-start justify-start mt-5">
                        <div class="flex flex-row space-x-3">
                            @if($user->is_admin)
                            <a href="{{ route('admin.index') }}" target="_blank" class="flex rounded-md bg-blue-500 py-2 px-4 text-white transition-all duration-150 ease-in-out hover:bg-blue-700">
                                Админ-панель
                            </a>
                            @endif
                            <form
