    ...
    <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
        ...
        <div :class="isOpen ? 'flex' : 'hidden'"
            ...
            <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
               href="/">
                <img src="{{ asset('assets/home.svg') }}" alt="" width="24" height="24" class="inline-block">
                Главная
            </a>
            <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
               href="{{ route('categories.index') }}">
                <img src="{{ asset('assets/entertainment.svg') }}" alt="" width="24" height="24" class="inline-block">
                Развлечения
            </a>
            <a class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400"
            ...
            @if (Route::has('login'))
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 hover:text-green-400">Регистрация</a>
                        @endif
                    @endauth
            @endif
        </div>
