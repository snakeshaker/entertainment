                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data" >
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div>
                                <img src="{{ asset('assets/'.$category->space_image) }}" alt="Image" class="w-32 h-32">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" id="res_price" min="0.00" max="10000.00" step="0.01" name="res_price" value="{{ $category->res_price }}"
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" id="limit" min="0" max="100" name="limit" value="{{ $category->limit }}"
