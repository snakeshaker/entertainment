                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.news.update', $news->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="{{ $news->news_title }}" type="text" id="news_title" name="news_title" class="@error('news_title') border-red-400 @enderror block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                            @error('news_title')
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div>
                                <img src="{{ asset('assets/'.$news->image) }}" alt="Image" class="w-32 h-32">
                            </div>
                            <div class="mt-1">
