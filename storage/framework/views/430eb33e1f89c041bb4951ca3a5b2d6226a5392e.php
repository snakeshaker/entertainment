    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">
                    Вернуться
                </a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="<?php echo e(route('admin.categories.update', $category->id)); ?>" enctype="multipart/form-data" >
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="<?php echo e($category->name); ?>" type="text" id="name" name="name" class="<?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div>
                                <img src="<?php echo e(asset('assets/'.$category->image)); ?>" alt="Image" class="w-32 h-32">
                            </div>
                            <div class="mt-1">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div>
                                <img src="<?php echo e(asset('assets/'.$category->space_image)); ?>" alt="Image" class="w-32 h-32">
                            </div>
                            <div class="mt-1">
...
unset($__errorArgs, $__bag); ?> shadow-sm focus:ring-indigo-500 appearance-none bg-white border py-2 px-3 text-base leading-normal transition duration-150 ease-in-out focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" id="res_price" min="0.00" max="10000.00" step="0.01" name="res_price" value="<?php echo e($category->res_price); ?>"
                                       class="<?php $__errorArgs = ['res_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" id="limit" min="0" max="100" name="limit" value="<?php echo e($category->limit); ?>"
                                       class="<?php $__errorArgs = ['limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
<?php endif; ?>
<?php /**PATH C:\Users\OpenServer\domains\entertainment.ru\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>