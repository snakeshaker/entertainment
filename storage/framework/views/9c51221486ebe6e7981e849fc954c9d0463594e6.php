                    ...
                    <div class="w-100 flex flex-grow flex-col items-start justify-start mt-5">
                        <div class="flex flex-row space-x-3">
                            ...
                            <form
                                id="destroy_entry"
                                method="POST"
                                action="<?php echo e(route('cabinet.destroy', $user->id)); ?>"
                            >
                                <?php echo csrf_field(); ?>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 bk-table admin-table">
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                                        <?php if($order->pay == 1): ?> Полная оплата
...
<?php endif; ?>
<?php /**PATH C:\Users\OpenServer\domains\entertainment.ru\resources\views/dashboard.blade.php ENDPATH**/ ?>