...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center relative"
         style="background-image: url('assets/media_entertainment.png'); font-family: 'Pacifico'">
        <h1
...
<?php endif; ?>
<?php /**PATH E:\OpenServer\domains\entertainment\resources\views/categories/index.blade.php ENDPATH**/ ?>