...
<?php $component->withAttributes([]); ?>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center bg-top bg-no-repeat bg-cover relative"
         style="background-image: url('<?php echo e(asset('assets/mainbanner.jpg')); ?>'); font-family: 'Pacifico'">
        <h1
        ...
        <div class="flex flex-col items-center mt-12 text-center z-[2] relative">
            <span class="relative inline-flex w-full md:w-auto">
                <a href="<?php echo e(route('categories.index')); ?>" type="button"
                        ...
                        <div class="xl:w-1/3 md:w-1/2 p-4">
                            <a href="<?php echo e(route('news.show', $new->id)); ?>">
                                <div class="bg-gray-100 p-6 rounded-lg">
                                    <img class="lg:h-60 xl:h-56 md:h-64 sm:h-72 xs:h-72 h-72  rounded w-full object-cover object-center mb-6" src="<?php echo e(asset('assets/'.$new->image)); ?>" alt="">
                                    <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font">ЗАГОЛОВОК</h3>
                                    <h2 class="text-lg text-gray-900 font-medium title-font mb-4"><?php echo e($new->news_title); ?></h2>
                                    <p class="leading-relaxed text-base truncate"><?php echo e($new->news_text); ?></p>
                                </div>
                            </a>
                        </div>
            ...
            <div class="flex flex-wrap items-center sm:-mx-3">
                <div class="w-full md:w-[45%] md:pr-5">
                    <div class="w-full h-auto overflow-hidden rounded-md sm:rounded-xl">
                        <img src="<?php echo e(asset('assets/mainfood.png')); ?>" />
                    </div>
                </div>
        ...
        <div class="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                    ...
                    <div class="w-full lg:max-w-md">
                        ...
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <img src="<?php echo e(asset('assets/experience.png')); ?>" alt="" width="50" height="50">
                                <span class="font-medium text-gray-500">Всё можно заказать онлайн</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <img src="<?php echo e(asset('assets/safety.png')); ?>" alt="" width="50" height="50">
                                <span class="font-medium text-gray-500">Комфорт и уют в заведениях</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <img src="<?php echo e(asset('assets/diversity.png')); ?>" alt="" width="50" height="50">
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img
                        ...
                        src="<?php echo e(asset('assets/whyus.png')); ?>"
...
<?php endif; ?>
<?php /**PATH E:\OpenServer\domains\entertainment\resources\views/welcome.blade.php ENDPATH**/ ?>