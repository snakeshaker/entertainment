        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="<?php echo e(route('admin.songs.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="sm:col-span-6">
                            <label for="singer" class="block text-sm font-medium text-gray-700"> Исполнитель </label>
                            <div class="mt-1">
                                <input type="text" id="singer" name="singer" class="<?php $__errorArgs = ['singer'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 mt-5">
                            ...
                            <div class="mt-1">
                                <input type="text" id="song_name" name="song_name" class="<?php $__errorArgs = ['song_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 mt-5">
                            ...
                            <div class="mt-1">
                                <input type="text" id="genre" name="genre" class="<?php $__errorArgs = ['genre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 mt-5">
                            ...
                            <div class="mt-1">
                                <input type="text" id="video_link" name="video_link" class="<?php $__errorArgs = ['video_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 <?php unset($message);
...
<?php endif; ?>
<?php /**PATH C:\Users\OpenServer\domains\entertainment.ru\resources\views\admin\songs\create.blade.php ENDPATH**/ ?>