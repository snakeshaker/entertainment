        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form enctype="multipart/form-data" method="POST" action="<?php echo e(route('admin.news.update', $news->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="sm:col-span-6">
                            <label for="news_title" class="block text-sm font-medium text-gray-700"> Заголовок </label>
                            <div class="mt-1">
                                <input value="<?php echo e($news->news_title); ?>" type="text" id="news_title" name="news_title" class="<?php $__errorArgs = ['news_title'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div>
                                <img src="<?php echo e(asset('assets/'.$news->image)); ?>" alt="Image" class="w-32 h-32">
                            </div>
                            <div class="mt-1">
...
<?php endif; ?>
<?php /**PATH C:\Users\OpenServer\domains\entertainment.ru\resources\views/admin/news/edit.blade.php ENDPATH**/ ?>