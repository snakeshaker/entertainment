                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="<?php echo e(route('admin.users.update', $user->id)); ?>" enctype="multipart/form-data" >
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="<?php echo e($user->name); ?>" type="text" id="name" name="name" class="<?php $__errorArgs = ['name'];
...
<?php endif; ?>
<?php /**PATH E:\OpenServer\domains\entertainment\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>