        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="<?php echo e(route('admin.reservations.store')); ?>" class="admin-res">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> form-multiselect block w-full mt-1">
                                    <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($table->id); ?>" data-table="<?php echo e($table->id); ?>" data-cat="<?php echo e($table->category->id); ?>" class="opt">
