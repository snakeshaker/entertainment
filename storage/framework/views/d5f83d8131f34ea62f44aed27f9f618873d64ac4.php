                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form enctype="multipart/form-data" method="POST" action="<?php echo e(route('admin.menus.update', $menu->id)); ?>">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input value="<?php echo e($menu->name); ?>" type="text" id="name" name="name" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                        </div>
                        <div class="sm:col-span-6">
                            <label for="image" class="block text-sm font-medium text-gray-700"> Image </label>
                            <div>
                                <img src="<?php echo e(\Illuminate\Support\Facades\Storage::url($menu->image)); ?>" alt="Image" class="w-32 h-32">
                            </div>
                            <div class="mt-1">
...
<?php endif; ?>
<?php /**PATH E:\OpenServer\domains\entertainment\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>