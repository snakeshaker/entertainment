            ...
            <?php if($category->name == 'Караоке-бар'): ?>
                ...
                <div class="flex flex-wrap justify-center overflow-hidden relative karaoke-room border">
                    ...
                    <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="my-2 px-2 w-1/4 overflow-hidden hover:scale-125 hover:cursor-pointer hover:text-blue-400 transition-all add-reservation relative">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-6 p-4 text-center">
                        <button type="submit" class="px-4 py-2 bg-blue-500 hover:bg-blue-700 rounded-lg text-white">
                            Забронировать
                        </button>
                    </div>
                </form>
